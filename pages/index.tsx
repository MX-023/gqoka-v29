  ...
  return (
    <section className="flex flex-col items-center text-center">
      ...
      <div className="mt-8 flex flex-wrap justify-center gap-3">
        <Link href="/wardrobe" className="rounded-xl bg-zinc-100 px-5 py-3 text-zinc-900 transition hover:bg-white">
          Commencer
        </Link>
        <Link href="/resale" className="rounded-xl border border-zinc-700 px-5 py-3 text-zinc-200 hover:border-zinc-400">
          Revendre
        </Link>
      </div>

      <div className="mt-14 max-w-3xl text-balance text-zinc-300">
        <p>Nous optimisons ce que tu possèdes déjà avant tout achat. Style sans compromis, impact mesuré.</p>
      </div>
    </section>
  );
}
